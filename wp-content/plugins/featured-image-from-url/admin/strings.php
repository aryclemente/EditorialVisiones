...
function fifu_get_strings_settings() {
    ...
    $fifu['video']['desc'] = function () {
        _e("FIFU supports videos from YouTube, Vimeo, Twitter, Imgur, 9GAG, Cloudinary, Tumblr, Publitio, JW Player, VideoPress, Sprout, Odysee, Rumble, Dailymotion, Cloudflare Stream, Bunny Stream, Amazon and BitChute. External and local video files are supported as well.", FIFU_SLUG);
    };
